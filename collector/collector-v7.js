// collector-v7.js — Configurable collector library (HW3 Module 08)
...
const collector = (function() {
  ...
  function notifyVitalsUpdate() {
    window.dispatchEvent(new CustomEvent('collector-v7:vitals-update', {
      detail: {
  ...
  function send(payload) {
    ...
    window.dispatchEvent(new CustomEvent('collector-v7:sent', {
  ...
  return { init, track, set, identify };
})();
