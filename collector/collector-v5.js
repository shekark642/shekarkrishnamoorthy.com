// collector-v5.js — Collector with Core Web Vitals (HW3 Module 06)
(function() {
  'use strict';
  ...
  function notifyVitalsUpdate() {
    window.dispatchEvent(new CustomEvent('collector-v5:vitals-update', {
      detail: {
  ...
  function collect() {
    ...
    send(payload);
    console.log('[collector-v5] pageview payload:', payload);
    window.dispatchEvent(new CustomEvent('collector-v5:collected', { detail: payload }));
    return payload;
  }
  ...
  function sendVitals() {
    ...
    send(payload);
    console.log('[collector-v5] vitals payload:', payload);
  }
  ...
  window.collectorV5 = {
    ...
    getVitalsScore, collect, sendVitals
  };
})();
